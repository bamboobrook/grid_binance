...
- normalized candidate rows: `34175`
...
- nearest by transparent gap score:
  ...
  - `saved_result_leak_audit` `dgt_dynamic_grid_probe_smoke.json` score `0.734` ann `23.98` gap `66.02` DD `8.29` excess `0.00` cap `200.00` cap_excess `0.00` pos `4` seg_gap `0` c2426 `40.96` c2426_gap `0.00`
  - `saved_result_leak_audit` `dgt_dynamic_grid_probe_g2.json` score `0.734` ann `23.98` gap `66.02` DD `9.19` excess `0.00` cap `100.00` cap_excess `0.00` pos `4` seg_gap `0` c2426 `40.96` c2426_gap `0.00`
  - `saved_result_leak_audit` `dgt_dynamic_grid_probe_g2.json` score `0.734` ann `23.98` gap `66.02` DD `9.19` excess `0.00` cap `200.00` cap_excess `0.00` pos `4` seg_gap `0` c2426 `40.96` c2426_gap `0.00`
  - `saved_result_leak_audit` `dgt_dynamic_grid_probe_g2.json` score `0.734` ann `23.98` gap `66.02` DD `9.19` excess `0.00` cap `300.00` cap_excess `0.00` pos `4` seg_gap `0` c2426 `40.96` c2426_gap `0.00`
- highest annualized rows:
