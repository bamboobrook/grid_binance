...
- reports indexed: `11`
- rows/symbols indexed where available: `129850`
...
- `target_gap_audit` rows `64415` passes `0` source `docs/superpowers/reports/2026-07-01-martingale-target-gap-audit.md`
