...
- reports indexed: `10`
- rows/symbols indexed where available: `75418`
...
- `target_gap_audit` rows `37199` passes `0` source `docs/superpowers/reports/2026-07-01-martingale-target-gap-audit.md`
